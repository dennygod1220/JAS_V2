...
function setDefaultZone(html, path) {
  ...
  var $ = cheerio.load(html);
  $(".etad").children().remove();
  $(".etad").append('<div style="text-align: center;"><ins class="clickforceads" style="display:inline-block;width:970px;height:250px;" data-ad-zone="8727"></ins><script async type="text/javascript" src="//cdn.doublemax.net/js/init.js"></script></div>');
  fs.writeFile(path+'/DefaultZone.html', $.html(), function () {
